...
- With **Authentication API 2** you can receive the access token that enables you to make an API call, and
- With **Elevator call WebSocket API 2** you can execute elevator calls and receive real-time data about the call and the assigned elevators, and
