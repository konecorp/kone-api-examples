...
import { fetchEquipmentStatus } from '../common/equipment-status-2-common-functions'
 ...
 */
const demoGetEquipmentStatus = async (accessToken: string, equipmentId: string) => {
...
const start = async () => {
  ...
  await demoGetEquipmentStatus(accessToken, KEN)
}
